...
public class DeepTestSkinPlayback extends EventLogTest{
    final static Logger logger = Logger.getLogger(DeepTestSkinPlayback.class);
    ...
    public void AspectRatioTest() throws Exception {
        ...
        try {
           ...
           // Thread.sleep(60000);
            ...
            //    end  //
            logger.info("Looking for Discovery");
        ...
        try {
          ...
          //  Thread.sleep(2000);
           ...
           /* Thread.sleep(50000);
            ...
            logger.info("Will now verify for discovery");
            po.discoverUpNext(driver);
            Thread.sleep(2000);
    ...
    public void SkinPlaybackVODCCVideo() throws Exception {
        ...
        try {
           ...
           /* driver.tap(1, locationPlayButton[0], locationPlayButton[1], 2);
            ...
            logger.error("SkinPlaybackVODCCVideo throws Exception " + e);
            e.printStackTrace();
        ...
        try {
         ...
         //   Thread.sleep(1000);
           ...
           /* driver.tap(1, locationPlayButton[0], locationPlayButton[1], 2);
            ...
            logger.error("SkinPlayBackVAST2ADPreroll throws Exception " + e);
            e.printStackTrace();
