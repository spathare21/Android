...
public class BasicTestsSkinPlayback {
    ...
    public void SkinPlaybackAspectRatio() throws Exception{
        ...
        try {
            ...
            po.assertCurrentActivityAgainst(driver, ".Settings$AppDrawOverlaySettingsActivity");

            // Wrire to console activity name of home screen app
            System.out.println("Ooyala Skin Settings Activity Launched successfully. Activity :- " + driver.currentActivity() + "\n");
