 ...
 */
public class DeepTest4Basicplayback {
    ...
    public void VAST_AD_Skippable_Long() throws Exception{
        try {
            ...
            //Postroll started
            ev.verifyEvent("adStarted", " Ad has been started ", 70000);
            ...
            // Postroll Skipped
            ev.verifyEvent("adSkipped", "Ad has been skipped", 80000);

            //Adcompleted Verficatrion
            ev.verifyEvent("adCompleted","Ad has been completed",90000 );
