...
public class BasicPlayBackBasicTests extends EventLogTest{
    ...
    public void VAST2_Midroll() throws Exception{
        ...
        {
            logger.error("VAST2_Midroll Exception "+e);
            e.printStackTrace();
    ...
    public void VAST2_Postroll() throws Exception{
        ...
        {
            logger.error("VAST2_Postroll Exception "+e);
            e.printStackTrace();
    ...
    public void VAST_Wrapper() throws Exception{
        ...
        {
            logger.error("VAST_Wrapper Exception "+e);
            e.printStackTrace();
    ...
    public void ooyalaAd_Preroll() throws Exception{
        ...
        {
            logger.error("ooyalaAd_Preroll Exception "+e);
            e.printStackTrace();
    ...
    public void ooyalaAd_Postroll() throws Exception{
        ...
        {
            logger.error("ooyalaAd_Postroll Exception "+e);
            e.printStackTrace();
